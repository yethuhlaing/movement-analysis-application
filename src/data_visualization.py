...
class VisualizationFrame(ttk.Frame):
    def __init__(self, parent):
        ...
        self.canvas = tk.Canvas(parent, bg="red", highlightthickness=0)  # Store the canvas reference here
        ...
        self.isFirstTime = checkFirstTimeDF()
        self.graphCouting = 0
...
class GraphicalWidget(ttk.Frame):
    def __init__(self, parent, category, movement, visualizationData, isFirstTime, index, graphCouting):
        ...
        setSummaryData("category", self.category )
        setSummaryData("movement", self.movement)
        ...
        self.horizontal_line.set(False)
    ...
    def create_information_widget(self, parentFrame):
        ...
        setSummaryData("minimum_time", minimum_time_inMinute)
        setSummaryData("maximum_time", maximum_time_inMinute)
        setSummaryData("minimum_duration", TooLow)
        setSummaryData("optimal_duration", Optimal)
        setSummaryData("maximum_duration", TooHigh)
